namespace Smart.IO.ByteMapper.Converters
{
    ...
    public class BigEndianDateTimeBinaryConverterTest
    {
        ...
        private readonly IMapConverter converter = new BigEndianDateTimeBinaryConverter(DateTimeKind.Unspecified);
    ...
    public class LittleEndianDateTimeBinaryConverterTest
    {
        ...
        private readonly IMapConverter converter = new LittleEndianDateTimeBinaryConverter(DateTimeKind.Unspecified);
