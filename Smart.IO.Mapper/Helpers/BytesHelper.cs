namespace Smart.IO.Mapper.Helpers
{
    ...
    public static class BytesHelper
    {
        ...
        public static void CopyPadRight(byte[] buffer, int offset, int length, byte[] bytes, byte filler)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void CopyPadLeft(byte[] buffer, int offset, int length, byte[] bytes, byte filler)
        {
