namespace ByteHelperTest.Tests
{
    ...
    public class DecimalTest2
    {
        ...
        public void ParseDecimal()
        {
            ...
            Assert.True(ByteHelper2.TryParseDecimalLimited64(buffer, 0, buffer.Length, 0x20, out var value));
            Assert.Equal(1234567890123456.78m, value);

            // Negative
            buffer = Encoding.ASCII.GetBytes("-1,234,567,890,123,456.78");
            Assert.True(ByteHelper2.TryParseDecimalLimited64(buffer, 0, buffer.Length, 0x20, out value));
            Assert.Equal(-1234567890123456.78m, value);
            ...
            Assert.False(ByteHelper2.TryParseDecimalLimited64(buffer, 0, buffer.Length, 0x20, out value));
        ...
        public void FormatDecimalLimited64(string input, string output, byte scale, int groupingSize, Padding padding, bool zerofill)
        {
            ...
            ByteHelper2.TryParseDecimalLimited64(bytes, 0, bytes.Length, (byte)' ', out var value);
